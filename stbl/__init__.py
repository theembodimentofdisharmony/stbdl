...
def window(path: str = None, mode: int = 3):
    ...
    :param path: The parameter `path` is the path to the background image, **must be an absolute path**. If no value is provided, it defaults to loading `stbl\\white.png`.
    ...
    pro = os.path.join(current_dir, "stbl.exe")
